                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body p-4">
										...
										<?php
											...
											$sql    = "SELECT * FROM eb_company_profile WHERE createdBy = " . $_SESSION["id"];
										...
										<div class="row">
											<div class="col-md-4 col-sm-12">
												<label class="form-label own-font">Company Name</label>
												<label id="lblOldCompanyName" hidden><?php echo $companyName; ?></label>
												<code>*</code>
												<input id="txtCompanyName" class="form-control form-control-sm own-font" type="text" placeholder="Enter Company Name" value="<?php echo $companyName; ?>">
											</div>
											<div class="col-md-8 col-sm-12">
												<label class="form-label own-font">Company Website (URL)</label>
												<code>*</code>
												<input id="txtCompanyWebsite" class="form-control form-control-sm own-font" type="text" placeholder="Enter Company Website" value="<?php echo $companyWebsite; ?>">
											</div>
										</div>
										<div style="height:10px;"></div>
										<div class="row">
											<div class="col-md-12 col-sm-12">
												<label class="form-label own-font">Company Address</label>
												<code>*</code>
												<!--<input id="txtItemName" class="form-control form-control-sm own-font" type="text" placeholder="Enter Company Website">
												-->
												<br>
												<textarea id="txtCompanyAddress" class="form-control form-control-sm own-font" placeholder="Enter Company Address" rows="2" cols="50"><?php echo $companyAddress; ?></textarea>
											</div>
										</div>
										<div style="height:10px;"></div>
										<div class="row">
