...
<html lang="en">
    ...
    <body>
										...
										<div class="row">
											<div class="col-md-9 col-xs-6">
												<div class="form-group">
													<input id="txtSearchItem" class="form-control form-control-sm" type="text" placeholder="Search person here...">
												</div>
											</div>
											<div class="col-md-3 col-xs-6">
												<div class="form-group">
													...
													<button id="btnExportItem" type="button" class="btn btn-primary btn-sm waves-effect btn-label waves-light" style="width: 100%;"><i class="bx bx-folder-open label-icon"></i>Export to Excel</button>
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-md-12 col-sm-12" >
												<div class="table-container">
													<table id="tblTopSeller" name="tblTopSeller" class="table table-bordered nowrap w-100 dataTable no-footer dtr-inline own-font" style="width: 100% !important; margin-top: 0px !important;">
														<thead>
															<tr>
																<th>Client Name</th>
																<th>Total Qty</th>
		...
		<script src="../code/js/topbuyer.js?random=<?php echo uniqid(); ?>"></script>
    </body>
</html>
