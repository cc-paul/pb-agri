...
<html lang="en">
    ...
    <body>
										...
										<div class="row">
											<div class="col-md-10 col-xs-12">
												<div class="form-group">
													<input id="txtSearchItem" class="form-control form-control-sm" type="text" placeholder="Search item here...">
												</div>
											</div>
		...
		<script src="../code/js/topseller.js?random=<?php echo uniqid(); ?>"></script>
    </body>
</html>
