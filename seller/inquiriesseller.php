                                    ...
                                    <div class="card-body p-4">
										<div class="row">
											<?php
												...
												$sql    = "
													SELECT
														CONCAT(b.lastName,', ',b.firstName,' ',b.middleName) AS complainant,
														DATE_FORMAT(a.dateCreated, '%m/%d/%Y') AS dateReported,
														CONCAT(d.lastName,', ',d.firstName,' ',d.middleName) AS reportedUser,
														a.ref,
														a.message,
														a.userIDreported AS reportedUserID
													FROM
														eb_inquiries a
													INNER JOIN
														eb_registration b
												...
												while ($row  = mysqli_fetch_row($result)) {
													?>
														...
														<div class="col-md-4 col-xs-12">
															<div class="card" style="height: 520px !important; max-height: 520px;">
																<div class="card-body">
																	<div class="d-flex align-items-center mb-4">
																		<div class="flex-grow-1">
																			<h5 class="font-size-14 mb-0"><?php echo $row["0"]; ?></h5>
																			<small class="text-muted">Date Reported : <?php echo $row["1"]; ?></small> 
																		</div>
																		<ul class="list-inline user-chat-nav text-end mb-0" hidden>
																			<li class="list-inline-item">
																				<div class="dropdown">
																					...
																					<div class="dropdown-menu dropdown-menu-end">
																						<a onclick="sendMessageToSeller(<?php echo $row["5"]; ?>)" class="dropdown-item" href="#">Send Message to Reported User</a>
																	...
																	<h4 class="font-size-16">Reported Seller : <?php echo $row["2"]; ?></h4>
						
																	<p>Ticket Number : <?php echo $row["3"]; ?></p>
																	<br>
																	<p><?php echo $row["4"]; ?>
																	</p>
																	<hr>
																	...
																	<div class="row">
																		<div class="col-xl-12 col-12">
																			<div class="card">
																				<img style="max-height: 213px; object-fit: cover;" class="card-img-top img-fluid" src="../assets/product/product-<?php echo $row["3"]; ?>.jpg" onerror="this.onerror=null;this.src='https://www.generationsforpeace.org/wp-content/uploads/2018/03/empty.jpg';" alt="Card image cap">
																				<div class="py-2 text-center">
																					<a href="../assets/product/product-<?php echo $row["3"]; ?>.jpg"  class="fw-medium" download>Download</a>
																				</div>
																			</div>
																		</div>
																	</div>
